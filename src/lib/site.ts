...
export const site = {
  ...
  turntablism: {
    ...
    collage: [
      ...
      {
        type: "img",
        media: "/assets/turntablism/turn-workshop-jam.jpg",
      ...
      {
        type: "loop",
        media: "/assets/turntablism/turn-workshop-kuching.mp4",
        alt: "Skratch session, hands on the turntable",
        aspect: "aspect-[4/5]",
      },
      {
        type: "loop",
        media: "/assets/turntablism/turn-workshop-lebanon-redbull.mp4",
